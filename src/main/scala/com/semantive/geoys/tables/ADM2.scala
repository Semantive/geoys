 ...
 */
object ADM2 extends FeatureTable[(Option[Int], String, String, Point, Int, Int, Int, Long, Int)]("ADM2") {
  ...
  def * = id.? ~ name ~ asciiName ~ location ~ countryId ~ admId ~ adm1Id ~ population ~ geoId
  /** Projection for INSERT queries. */
  def forInsert = name ~ asciiName ~ location ~ countryId ~ admId ~ adm1Id ~ population ~ geoId
